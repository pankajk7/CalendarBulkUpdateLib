...
public class CalendarView extends FrameLayout {
    ...
    public CalendarView(Context context, AttributeSet attrs) {
        ...
        mLightTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/Raleway-Light.ttf");
    ...
    public FluentInitializer init(Date minDate, Date maxDate, Locale locale, Date minRangeDate, Date maxRangeDate) {
    ...
    public FluentInitializer init(Date minDate, Date maxDate) {
        return init(minDate, maxDate, Locale.getDefault(),mMinRangeCal.getTime(),mMaxRangeCal.getTime());
    }
    ...
    private void validateDate(Date date) {
        ...
        if (date.before(mMinRangeCal.getTime()) || date.after(mMaxRangeCal.getTime())) {
            throw new IllegalArgumentException(
    ...
    public List<WeekCellDescriptor> getWeekCells(WeekDescriptor week, Calendar startCal) {
        ...
        for (int c = 0; c < 7; c++) {
            ...
            boolean isSelectable = betweenDates(cal, mMinRangeCal, mMaxRangeCal) && isDateSelectable(date);
    ...
    private class CellClickedListener implements WeekView.Listener {
        ...
        public void handleClick(WeekCellDescriptor cell) {
            ...
            if (!betweenDates(clickedDate, mMinRangeCal, mMaxRangeCal) || !isDateSelectable(clickedDate)) {
    ...
    private class DefaultOnInvalidDateSelectedListener implements OnInvalidDateSelectedListener {
        ...
        public void onInvalidDateSelected(Date date) {
            String errMessage =
                    getResources().getString(R.string.invalid_date, mFullDateFormat.format(mMinRangeCal
                            .getTime()),
